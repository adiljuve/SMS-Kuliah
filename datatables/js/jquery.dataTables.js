	...
	$.fn.dataTable = function( oInit )
	{
                ...
                ($.inArray('asc', oCol.asSorting) == -1 && $.inArray('desc', oCol.asSorting) == -1) )
      {
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = '<form class="jNice"><fieldset><label>'+sSearchStr+'</label></fieldset></form>';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			nLength.innerHTML = '<form class="jNice"><fieldset><label>'+oSettings.oLanguage.sLengthMenu.replace( '_MENU_', sStdMenu )+'</label></form>';
