                <h2><?php echo $title;?> &raquo; Tambah Matakuliah &raquo; Dosen: <?php foreach ($queryDosen as $dosen):?><?php echo $dosen->nama_dosen;?><?php endforeach;?></h2>                   <div id="main">		
					...
					<h3>Daftar Matakuliah</h3>
						...
						<?php $no=1;if ($queryMatakuliah):?>
							...
							<?php } ?>
                                ...
                                <td class="action"><a href="#" onClick="kirim('<?php echo base_url();?>pengumuman/kirimPengumuman/<?php echo $matakuliah->kode_matakuliah;?>')" class="message">Kirim</a> <a href="<?php echo base_url().$class;?>/editMatakuliahDosen/<?php echo $matakuliah->kode_matakuliah;?>" class="edit">Edit</a> <a href="#" onClick="hapus('<?php echo base_url().$class; ?>/hapusMatakuliah/<?php echo $matakuliah->kode_matakuliah;?>')" class="delete">Hapus</a></td>
                            </tr>
							<?php endforeach;?>
						<?php else: ?>
							<tr>
					...
					<h3>Tambah Matakuliah</h3>
                    	<fieldset>
							...
							<input type="hidden" name="dosen" id="dosen" value="<?php echo $dosen->id_dosen;?>">
							<?php endforeach;?>
